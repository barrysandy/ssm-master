    ...
    <div class="row  border-bottom white-bg dashboard-header">
        <div class="col-sm-12">
            <blockquote class="text-warning" style="font-size:14px">
                ...
                <span style="margin-bottom: 5px;">[2018-04-06 11:00]更新商品属性，新增商品价格编辑器（多价格以及排序等规则）。</span><br>
                <span style="margin-bottom: 5px;">[2018-04-05 11:00]新增订单退款功能，订单添加统计和导出表的功能。</span><br>
                <span style="margin-bottom: 5px;">[2018-04-04 11:00]更新商品属性，以及运营端C端（C端动态多价格）。</span><br>
            </blockquote>
