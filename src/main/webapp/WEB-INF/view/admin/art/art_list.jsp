    ...
    <script>
        function view (id) {
            layer.open({
                ...
                area: ['95%', '95%'],
                content: '${path}/art/toView.htm?id=' + id
            });
        }
        ...
        function add(menuId){
            layer.open({
                ...
                skin: 'layui-layer-rim',
                area: ['95%', '95%'],
                content: '${path}/art/toEdit.htm?menuId='+ menuId
            });
        }
        ...
        function edit(id,menuId) {
            layer.open({
                ...
                skin: 'layui-layer-rim',
                area: ['95%', '95%'],
                content: '${path}/art/toEdit.htm?id=' + id +'&menuId='+menuId
            });
        }
    ...
    <div class="m-tabs head-top style01" id="tabs" an-tabs>
        <div class="m-tabs-content">
            <div class="item f-p-xs activate">
                <div class="g-h-max">
                    <form id="listForm" method="post" action="${path}/art/list.htm">
                            ...
                            <div class="layout-center">
                                <table class="m-table" id="table1" an-datagrid style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <th style="width:80px" align="center">内容</th>
                                        <th style="width:80px" align="center">封面</th>
                                        <th style="width:80px" align="center">链接</th>
                                        <th style="width:80px" align="center">发布日期</th>
                                        <th style="width:80px" align="center">期/栏</th>
                                    ...
                                    <c:forEach var="bean" items="${pager.list}" varStatus="status">
                                        <tr>
                                            ...
                                            <td align="center">${bean.artTitle}</td>
                                            <td align="center">${bean.artSummary}</td>
                                            <td align="center">${bean.artImg}</td>
                                            <td align="center">${bean.artUrl}</td>
                                            <td align="center"><fmt:formatDate value="${bean.createTime}" pattern="yyyy-MM-dd HH:mm"></fmt:formatDate></td>
                                            <td align="center">${bean.currentPeriod}期/${bean.currentPeriodSort}栏</td>
                                            <td align="center">
