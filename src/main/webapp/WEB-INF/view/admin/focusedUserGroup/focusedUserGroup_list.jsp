    ...
    <script>
        function view (id) {
            layer.open({
                ...
                area: ['800px', '600px'],
                content: '${path}/focusedUserGroup/toView.htm?id='+id
            });
        }
        ...
        function add(menuId){
            layer.open({
                ...
                skin: 'layui-layer-rim',
                area: ['800px', '600px'],
                content: '${path}/focusedUserGroup/toEdit.htm?menuId='+ menuId
            });
        }
        ...
        function edit(id,menuId) {
            layer.open({
                ...
                skin: 'layui-layer-rim',
                area: ['800px', '600px'],
                content: '${path}/focusedUserGroup/toEdit.htm?id='+id+'&menuId='+menuId
            });
        }
        ...
        function deleted(id) {
            var url = "${path}/focusedUserGroup/del.htm";
    ...
    <div class="m-tabs head-top style01" id="tabs" an-tabs>
        <div class="m-tabs-content">
            <div class="item f-p-xs activate">
                <div class="g-h-max">
                    <form id="listForm" method="post" action="${path}/focusedUserGroup/list.htm">
                            ...
                            <div class="layout-center">
                                <table class="m-table" id="table1" an-datagrid style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <th style="width:80px" align="center">分组名</th>
                                        <th style="width:80px" align="center">现有人数</th>
                                        <th style="width:80px" align="center">允许最大分组人数</th>
                                    ...
                                    <c:forEach var="bean" items="${pager.list}" varStatus="status">
                                        <tr>
                                            ...
                                            <td align="center">${bean.groupName}</td>
                                            <td align="center">${bean.number}</td>
                                            <td align="center">${bean.mixNumber}</td>
