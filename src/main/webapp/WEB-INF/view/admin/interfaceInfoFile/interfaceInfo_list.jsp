    ...
    <script>
        ...
        function add(){
            layer.open({
                ...
                skin: 'layui-layer-rim',
                area: ['800px', '600px'],
                content: '${path}/interfaceInfo/toEditFile'
            });
        }
        ...
        function edit(id) {
            layer.open({
                ...
                skin: 'layui-layer-rim',
                area: ['800px', '600px'],
                content: '${path}/interfaceInfo/toEditFile?id='+id
            });
        }
                        ...
                        <div class="g-layout m-panel u-datagrid f-b f-b-n-b">
                            <div class="layout-head panel-head">
                                ...
                                <div class=" panel-head-btnbar f-right">
                                    ...
                                    <div class="u-group sm f-m-t-xxss select-combo-s" style="width: 160px;">
                                        <span class="clabel" style="width: 40px;color: #6B6B6B;">类型:</span>
                                        <select style="width: 120px;" class="cselect" name="type" onchange="submitForm()">
                                            <option value="3" <c:if test="${type == 3}">selected="selected"</c:if>>文件系统接口</option>
                                        </select>
                                    </div>
