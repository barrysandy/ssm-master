    ...
    <script>
        function view (id) {
            layer.open({
                ...
                area: ['95%', '95%'],
                content: '${path}/activityPrize/toView.htm?id='+id
            });
        }
        ...
        function add(menuid){
            layer.open({
                ...
                skin: 'layui-layer-rim',
                area: ['95%', '95%'],
                content: '${path}/activityPrize/toEdit.htm?menuid='+ menuid
            });
        }
        ...
        function edit(id,menuid) {
            layer.open({
                ...
                skin: 'layui-layer-rim',
                area: ['95%', '95%'],
                content: '${path}/activityPrize/toEdit.htm?id='+id+'&menuid='+menuid
            });
        }
        ...
        function deleted(id) {
            var url = "${path}/activityPrize/del.htm";
    ...
    <div class="m-tabs head-top style01" id="tabs" an-tabs>
        <div class="m-tabs-content">
            <div class="item f-p-xs activate">
                <div class="g-h-max">
                    <form id="listForm" method="post" action="${path}/activityPrize/list.htm">
                        ...
                        <div class="g-layout m-panel u-datagrid f-b f-b-n-b">
                            <div class="layout-head panel-head">
                                ...
                                <div class=" panel-head-btnbar">
                                    <a class="u-btn sm success" type="button" href="${path}/activityPrize/list">
                            ...
                            <div class="layout-center">
                                <table class="m-table" id="table1" an-datagrid style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <th style="width:80px" align="center">奖品名称</th>
                                        <th style="width:80px" align="center">奖品描述</th>
                                        <th style="width:80px" align="center">奖品数量</th>
                                        <th style="width:80px" align="center">所属活动</th>
                                        <th style="width:80px" align="center">绑定商品</th>
                                    ...
                                    <c:forEach var="bean" items="${pager.list}" varStatus="status">
                                        <tr>
                                            ...
                                            <td align="center">${bean.quantity}</td>
                                            <td align="center">${bean.wechatActivityId}</td>
                                            <td align="center">
                                                <c:if test="${bean.commodityId == -1}">未绑定商品</c:if>
                                                <c:if test="${bean.commodityId != -1}">商品ID：${bean.commodityId }</c:if>
                                            </td>
