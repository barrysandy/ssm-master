...
<head>
    ...
    <script>
        function saveOrUpdate() {
            var url = "${base}/sysCode/saveOrUpdate";
        ...
        function cancel() {
            window.parent.initCodeList('${categoryId}');
...
<div class="g-layout">
    <div class="layout-center">
        <form id="editForm" action="${path}/sysCode/saveOrUpdate" method="post">
            <div class="g-max f-p-xs f-p-t-n" id="PrintContentDiv">
                <input type="hidden" name="id" value="${bean.id}">
                <table class="m-table-forms inline">
                    <tr>
                        <td align="center" colspan="8" class="f-b-n" style="font-size:18px">系统字典表</td>
                    </tr>
                    <tr style="display: none">
                        <td class="table-header">目录ID<span style="color: red">*</span></td>
                        <td colspan="7">
                            <input type="text" class="u-input" name="categoryId" value="${categoryId}">
                        </td>
                    </tr>
                    <tr>
                        <td class="table-header">名字<span style="color: red">*</span></td>
                        <td colspan="7"><input type="text" class="u-input" name="name" value="${bean.name}"></td>
                    </tr>
                    <tr>
                        <td class="table-header">值<span style="color: red">*</span></td>
                        <td colspan="7"><input type="text" class="u-input" name="value" value="${bean.value}"></td>
                    </tr>
                    <tr>
                        <td class="table-header">排序<span style="color: red">*</span></td>
