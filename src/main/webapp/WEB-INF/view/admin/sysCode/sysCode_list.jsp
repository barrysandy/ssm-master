    ...
    <script>
        function view (id) {
            layer.open({
                ...
                area: ['800px', '600px'],
                content: '${path}/sysCode/toView.htm?id='+id
            });
        }
        ...
        function add(menuId){
            layer.open({
                ...
                skin: 'layui-layer-rim',
                area: ['800px', '600px'],
                content: '${path}/sysCode/toEdit.htm?menuId='+ menuId
            });
        }
        ...
        function edit(id,menuId) {
            layer.open({
                ...
                skin: 'layui-layer-rim',
                area: ['800px', '600px'],
                content: '${path}/sysCode/toEdit.htm?id='+id+'&menuId='+menuId
            });
        }
    ...
    <div class="m-tabs head-top style01" id="tabs" an-tabs>
        <div class="m-tabs-content">
            <div class="item f-p-xs activate">
                <div class="g-h-max">
                    <form id="listForm" method="post" action="${path}/sysCode/list.htm">
